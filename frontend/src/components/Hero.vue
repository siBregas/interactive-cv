...
col md:flex-row items-center bg-gray-900">

<div class="md:w-1/2 mb-10 md:mb-0">

<h1 class="text-5xl font-bold text-white mb-4 animate-slide-
in-left" style="animation-delay: 200ms;">

Halo, Saya <span class="text-blue-400">Dimas Bregas Khalis S</span>
</h1>
